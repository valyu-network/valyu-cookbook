      ...
      {showDiscordBanner && (
        <div className="fixed top-4 left-4 right-4 md:left-20 md:right-auto z-50">
          <a
            ...
            className="group inline-flex items-center gap-2 px-3 py-2 md:px-4 md:py-2.5 bg-[#5865F2] hover:bg-[#4752C4] text-white rounded-lg shadow-notion-sm transition-notion text-sm"
          >
            {/* Discord Icon */}
